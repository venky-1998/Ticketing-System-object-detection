...
#username_password_list =[['ujalapathak921@gmail.com','ujju@10'],['vjamdade1998@gmail.com','ujju@10']]
...
#auth=dash_auth.BasicAuth(app, username_password_list)
server = app.server
                            ...
                            children=[
                                ...
                                dcc.Dropdown(
                                    ...
                                    options=[
                                        ...
                                        #d{'label': 'Display with Bounding Boxes', 'value': 'bounding_box'},
                                    ],
                                    value='bounding_box',
                                    searchable=False,
                                    clearable=False,
